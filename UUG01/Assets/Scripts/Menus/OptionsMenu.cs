...
public class OptionsMenu : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        menuItems = new OptionsMenuItem[itemsCount];
        for (int i = 0; i < itemsCount; i++)
        {
            // +1 to ignore the main button
            menuItems[i] = transform.GetChild(i + 1).GetComponent<OptionsMenuItem>();
        }
    ...
    void ToggleMenu()
    {
        ...
        else
        {
            ...
            //rotate/rewine main button around axis by 360f to be in starting position
            mainButton.transform
                 .DORotate(Vector3.back * 360f, rotationDuration)
                 .SetEase(rotationEase);
        }
    }
